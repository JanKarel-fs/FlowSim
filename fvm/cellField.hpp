...
template <typename T>
inline CellField<T> operator+(const CellField& a, const CellField& b) {
...
inline CellField<T> operator*(const CellField& a, const S& b) {
  CellField<T> c(a.M(), a.N(), a.gh());
...
template <typename T, typename S>
inline CellField<T> operator*(const S& b, const CellField& a) {
  CellField<T> c(a.M(), a.N(), a.gh());
...
template <typename T>
inline CellField<T> operator+=(CellField& a, const CellField& b) {
  if (a.M()!=b.M() || a.N()!=b.n() || a.gh()!=b.gh()) {
    cout << "Nelze scitat (+=) pole CellField ruznych velikosti!" << endl;
    exit(4);
  }
...
template <typename T, typename S>
inline CellField<T> operator*=(CellField& a, const S& b) {
